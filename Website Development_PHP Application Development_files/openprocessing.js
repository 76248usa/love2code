...
OP.setupImageLoading = function (selector) {
	if (typeof selector == 'undefined') {
		selector = '.sketchThumb:not(.noUnveil), .userThumb:not(.noUnveil)';
	}
...
OP.listSketches = function (selector, data, classes) {
	...
	sketchesContainer
		...
		.attr('data-src', function (d) {
			return 'https://s3.amazonaws.com/openprocessing-usercontent/thumbnails/visualThumbnail' + d.visualID + (d.visualID > 385700? '@2x.jpg':'.jpg');
		})

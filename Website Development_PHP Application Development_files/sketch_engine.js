...
sketchEngine.setupPjs = function (code, giveFocus) {
    ...
    var head = '<head><title>Sketch Iframe</title><base href="/sketch/' + sketch.visualID + '/files/"><link><link rel="stylesheet" href="/assets/css/sketch/sketchIframe.css"></head>';
    ...
    var mousetrap = '<script src="/assets/js/vendor/mousetrap-master/mousetrap.min.js"></script>';
    var allExtension = '<script language="javascript" type="text/javascript" src="/assets/js/sketch/all_OPextension.js"></script>';
    var giveFocusScript = giveFocus? '<script language="javascript" type="text/javascript" src="/assets/js/sketch/iframe_giveFocus.js"></script>':'';
...
sketchEngine.setupP5js = function (code, giveFocus) {
    ...
    var head = '<head><title>Sketch Iframe</title><base href="/sketch/' + sketch.visualID + '/files/"><link rel="stylesheet" href="/assets/css/sketch/sketchIframe.css"></head>';
